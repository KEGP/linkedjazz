...
python mapping/mapfiles.py ./mapping/artist-work-relation.sparql ./data/musicbrainz/work/ ./resources/ $TEMPLATE_OPT $SPARQL_OPT --outprefix artist_work
python mapping/mapfiles.py ./mapping/artist-recording-relation.sparql ./data/musicbrainz/recording/ ./resources/ $TEMPLATE_OPT $SPARQL_OPT --outprefix artist_recording
